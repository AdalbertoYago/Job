Public Class ReportClassica
    ...
    Public Sub New(ByVal sFunc As String, ByVal sData As String)
        ...
        ''###SELECIONA EPI
        querySQl.Connection = conSQL
        querySQl.CommandText = "Select EPI.*,Estoque.Descricao From EPI Left Join Estoque On EPI.CDEPI = Estoque.CDProduto Where CDFuncionario = '" & gFunc & "' And DTRetirada = convert(datetime,'" & gData & "',103)"
