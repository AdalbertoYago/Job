...
Public Class frmEstruturaSubCJ
    ...
    Public Sub carregaGrid()
        ...
        adaptSQL = New SqlClient.SqlDataAdapter("Select a.*,(select b.Descricao from Estoque b where b.CDProduto=a.CDItem) as Descricao From EstruturaSubCJ a Where a.CDProduto = '" & sProduto.PadLeft(7, "0") & "' order by a.Posicao", conSQL2)
        adaptSQL.Fill(datPubsEstoque, "EstruturaSubCJ")
        GridControl1.DataSource = datPubsEstoque.Tables("EstruturaSubCJ")
    End Sub
    Private Sub bt0Imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bt0Imprimir.Click
        If sProduto <> "" Then
            ...
            End If
            HeaderArea.Content.Add("Estrutura de SubCj.: " & sProduto & " - " & sNomeProd)
            ...
            If datRead.Read = True Then
                ...
                If datRead.Read = True Then
                    ...
                    If MessageBox.Show("Confirma a cópia da estrutra?" & vbCrLf & "Lembre-se que a estrutura filho será apagada e recriada de acordo com a estrutura pai!", "Pergunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        querySQL2.CommandText = "delete from EstruturaSubCJ where CDProduto='" & VCodFilho.PadLeft(7, "0") & "'"
                        querySQL2.ExecuteNonQuery()

                        querySQL2.CommandText = "Select * from EstruturaSubCJ where CDProduto='" & VCodPai.PadLeft(7, "0") & "'"
                        datRead2 = querySQL2.ExecuteReader()
                        Do Until datRead2.Read = False
                            'JOGA DADOS NA ESTRUTURA FILHA
                            querySQl.CommandText = "Insert into EstruturaSubCJ (CDProduto,CDItem,Qtde,Unidade,Posicao) values ('" & VCodFilho.PadLeft(7, "0") & "','" & datRead2("CDItem") & "'," & Replace(datRead2("Qtde"), ",", ".") & ",'" & datRead2("Unidade") & "','" & datRead2("Posicao") & "')"
    ...
    Private Sub GridControl1_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GridControl1.KeyUp
        If e.KeyCode = Keys.Delete Then
            ...
            If classParam.selPermissoes(296, gCDPerfil, gDataSource, gUserID, gPWD, gInitialCatalog) = True Then
                ...
                querySQL2.Connection = conSQL2
                Try
                    querySQL2.CommandText = "delete from EstruturaSubCJ where CDProduto='" & txtCDProduto.Text & "' and Posicao ='" & row("Posicao") & "'"
                    querySQL2.ExecuteNonQuery()
                    row.Delete()
        ...
        Try
            If row.RowState = DataRowState.Added Then
                If classParam.selPermissoes(294, gCDPerfil, gDataSource, gUserID, gPWD, gInitialCatalog) = True Then
                    ...
                    querySQL2.Connection = conSQL2
                    Try
                        querySQL2.CommandText = "Insert into EstruturaSubCJ (CDProduto,CDItem,Qtde,Unidade,Posicao) values ('" & txtCDProduto.Text & "','" & row("CDItem") & "'," & Replace(row("Qtde"), ",", ".") & ",'" & row("Unidade") & "','" & row("Posicao") & "')"
                        querySQL2.ExecuteNonQuery()
                        carregaGrid()
                    Catch ex As Exception
                        MessageBox.Show(ex.Message(), "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub GridView1_RowUpdated(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowObjectEventArgs) Handles GridView1.RowUpdated
        ...
        If row.RowState = DataRowState.Modified Then
            If classParam.selPermissoes(295, gCDPerfil, gDataSource, gUserID, gPWD, gInitialCatalog) = True Then
                ...
                querySQL2.Connection = conSQL2
                Try
                    querySQL2.CommandText = "update EstruturaSubCJ set Qtde=" & Replace(row("Qtde"), ",", ".") & ",Unidade='" & row("Unidade") & "', Posicao='" & row("Posicao") & "' where CDProduto='" & txtCDProduto.Text & "' and CDItem ='" & row("CDItem") & "'"
                    querySQL2.ExecuteNonQuery()
                Catch ex As Exception
                    MessageBox.Show(ex.Message(), "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Try
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        If sCDItem <> "" Then
            ...
            s.Show()
        Else
            MessageBox.Show("Selecione um Subconjunto!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
End Class
