...
Public Class frmKardexEmpenho
    ...
    Public Sub busca()
        ...
        datPubsKardex.Clear()
        adaptSQL = New SqlClient.SqlDataAdapter("select * from Kardex2 where Data Between convert(datetime,'" & txtDe.Text & "',103) and convert(datetime,'" & dDataAte & "',103) " & sBusca & " order by Registro Desc", conSQL2)
    ...
    Private Sub bt0ExcluirEndereco_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bt0ExcluirEndereco.Click
        If classParam.selPermissoes(234, gCDPerfil, gDataSource, gUserID, gPWD, gInitialCatalog) = True Then
            ...
            If sRegistro <> "" Then
                ...
                querySQl.CommandText = "Delete from Kardex2 where Registro='" & sRegistro & "'"
        ...
        If classParam.selPermissoes(234, gCDPerfil, gDataSource, gUserID, gPWD, gInitialCatalog) = True Then
            If MessageBox.Show("Confirma a gravação dos dados", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If VTipo = "System.Double" Then
                    gVSQL = "UPDATE Kardex2 SET " & VCampo & " = " & Replace(VDado, ",", ".") & " WHERE Registro = " & Row("Registro")
                ElseIf VTipo = "System.String" Then
                    gVSQL = "UPDATE Kardex2 SET " & VCampo & " = '" & VDado & "' WHERE Registro = " & Row("Registro")
                ElseIf VTipo = "System.DateTime" Then
                    gVSQL = "UPDATE Kardex2 SET " & VCampo & " = Convert(DateTime,'" & VDado & "',103) WHERE Registro = " & Row("Registro")
                ElseIf VTipo = "System.Boolean" Then
                    If VDado = True Then
                        gVSQL = "UPDATE Kardex2 SET " & VCampo & " = 1 WHERE Registro = " & Row("Registro")
                    Else
                        gVSQL = "UPDATE Kardex2 SET " & VCampo & " = 0 WHERE Registro = " & Row("Registro")
                    End If
                End If
                Try
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        HeaderArea.Content.Add("Ficha Kardex Empenho")
